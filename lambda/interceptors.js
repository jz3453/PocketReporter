...
const PERSISTENT_ATTRIBUTES_NAMES = ['lastThreeTopics', 'favorites', 'sessionCounter'];
...
const SaveAttributesResponseInterceptor = {
    async process(handlerInput, response) {
        ...
        if ((shouldEndSession || Alexa.getRequestType(requestEnvelope) === 'SessionEndedRequest') && loadedThisSession) { // skill was stopped or timed out
            ...
            sessionAttributes['lastThreeTopics'] = sessionAttributes['lastThreeTopics'] ? sessionAttributes['lastThreeTopics'] : [];
